...
<div class="col-lg-9">
	<div class="dashLeftCont">
        <p class="fs20 m20">Recently Played Games</p>
        ...
        <div class="tableOuter">
        	<table class="table">
                ...
                $statement = "users_logs  WHERE type='10' and uid='$_SESSION[uid]'";
                $query = $db->query("SELECT * FROM {$statement} ORDER BY time DESC LIMIT {$startpoint} , {$limit}");
